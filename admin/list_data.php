                                ...
                                <div class="card shadow-lg">
                                    ...
                                    <div class="card-body font-weight-bold">
                                       ...
                                       <thead>
                                        <tr>
                                          <th style="width:5%;">#</th>
                                          <th style="width:15%;text-align:center;">Image Name</th>
                                          <th style="width:20%;text-align:center;">Images</th>
                                          <th style="width:35%;text-align:center;">Image Description</th>
                                                ...
                                                while ($row = mysqli_fetch_array($run)) {
                                                    ...
                                                    ?>
                                                     <tr>
                                                         ...
                                                         <td style="width:30%;">
                                                            <center>
                                                                <img style="width:10%;height:10%" src="Image/<?php echo $row['image']; ?>">
                                                            </center>
                                                         </td>
